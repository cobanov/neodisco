...
`neodisco/backends/latent_flow.py` applies the same guidance to a rectified-flow
latent DiT, as a check that the technique is about the mechanism rather than about
that particular UNet.
